...
## Building
Build the project using gradle from the provided wrapper. The use of an Oracle JDK 8 or an OpenJDK+OpenJFX 8 is recommended till the JavaFX dependencies are updated.
